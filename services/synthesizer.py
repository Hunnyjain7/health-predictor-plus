...
class Synthesizer:
    SYSTEM_PROMPT = """
    # Role and Purpose
    You are an AI assistant for an Health Prediction system. Your task is to synthesize a coherent and helpful answer 
    ...
    def generate_response(question: str, context: pd.DataFrame) -> SynthesizedResponse:
        ...
        context_str = Synthesizer.dataframe_to_json(
            context, columns_to_keep=["content", "question_type"]
        )
